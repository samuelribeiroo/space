  ...
  return (
    <footer className="w-full bg-transparent text-white/80 py-4 px-6 border-t border-white/10 mt-48">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="mt-3 flex-col gap-3 text-center text-sm md:text-base font-inter">
          <p>&copy; {new Date().getFullYear()} Samuel Ribeiro</p>
          <small className="flex items-center justify-center gap-2">
            made in <BrazilianFlag />
          </small>
        </div>
      </div>
    </footer>
  ...
  return (
    ...
    >
      ...
      <defs>
        ...
        ></path>
        <use id="q" transform="scale(15)"></use>
        <use id="s" transform="scale(10.5)"></use>
        <use id="r" transform="scale(21)"></use>
        <use id="o" transform="scale(31.5)"></use>
        <use id="p" transform="scale(26.25)"></use>
        <g id="a" fill="#fff">
          <g id="c">
            <path id="b" transform="rotate(18 0 -1)" d="M0-1v1h.5"></path>
            <use transform="scale(-1 1)"></use>
          </g>
          <use transform="rotate(72)"></use>
          <use transform="rotate(-72)"></use>
          <use transform="rotate(144)"></use>
          <use transform="rotate(216)"></use>
        </g>
        <g id="m">
          <clipPath id="e">
            <path d="M-31.5 0v-70h63V0zM0-47v12h31.5v-12z"></path>
          </clipPath>
          <use clip-path="url(#e)"></use>
      ...
      <g transform="translate(-420 1470)" fill="#009b3a">
        <use y="-1697.5" transform="rotate(-7)"></use>
        <use y="-1697.5" transform="rotate(-4)"></use>
        <use y="-1697.5" transform="rotate(-1)"></use>
        <use y="-1697.5" transform="rotate(2)"></use>
        <use y="-1697.5" transform="rotate(5)"></use>
        <use y="-1697.5" transform="rotate(9.75)"></use>
        <use y="-1697.5" transform="rotate(14.5)"></use>
        <use y="-1697.5" transform="rotate(17.5)"></use>
        <use y="-1697.5" transform="rotate(20.5)"></use>
        <use y="-1697.5" transform="rotate(23.5)"></use>
        <use y="-1697.5" transform="rotate(26.5)"></use>
        <use y="-1697.5" transform="rotate(29.5)"></use>
        <use y="-1697.5" transform="rotate(32.5)"></use>
        <use y="-1697.5" transform="rotate(35.5)"></use>
        <use y="-1697.5" transform="rotate(38.5)"></use>
      </g>
      <use y="-132" x="-600"></use>
      <use y="177" x="-535"></use>
      <use y="243" x="-625"></use>
